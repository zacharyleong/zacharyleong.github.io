...
<ImageGallery 
  images={[
    { src: '/img/blog/rampage/rampage.png', alt: 'Final rendered scene' },
    { src: '/img/blog/rampage/rampage-1.png', alt: 'Character sculpt wireframe' },
    { src: '/img/blog/rampage/rampage-2.png', alt: 'Final rendered scene' },
    { src: '/img/blog/rampage/rampage-3.png', alt: 'Final rendered scene' }
  ]}
